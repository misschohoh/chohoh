...
***************************************************************************/
        ...
        Preview.prototype = {
            create : function() {
                ...
                this.$detailButtonList2 = $( '<span class="icons-list"></span>');
                this.$title = $( '<h3></h3>' );
                this.$description = $( '<p></p>' );
                this.$description2 = $( '<p span="skill"></p>' );
                this.$href = $( '<a href="#">Visit website</a>' );
                this.$detailButtonList = $( '<span class="buttons-list"></span>' );

                this.$details = $( '<div class="og-details"></div>' ).append( this.$detailButtonList2, this.$title, this.$description, this.$description2, this.$detailButtonList );
            ...
            update : function( $item ) {
                ...
                if(typeof config.items[current] === "undefined"){
                    ...
                    this.$detailButtonList2.html("");
                    urlList = eldata.icon_list;

                    if(urlList.length > 0){
                        for (i = 0; i < urlList.length; i++)
                        {
                            var ObjA = $('<a target="_blank"></a>');
                            ObjA.addClass('icon-button');
                            if(i==0){
                                ObjA.addClass('first');
                            }
                            ...
                            this.$detailButtonList2.append(ObjA);
                    ...
                    this.$description2.html( eldata.description2 );
